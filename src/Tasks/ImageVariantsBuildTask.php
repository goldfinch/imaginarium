...
class ImageVariantsBuildTask extends BuildTask
{
    private static $segment = 'ImageVariants';

    protected $enabled = true;

    protected $title = 'Image variants';

    protected $description = 'Collect and store info of all existing images variants';
